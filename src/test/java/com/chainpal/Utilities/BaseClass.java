...
public class BaseClass {
    ...
    public void setup() throws IOException {
        ...
        chromeOptions.addExtensions(new File("/Users/Viren/Work/Automation/old_chainpal_automation/Data/nkbihfbeogaeaoehlefnkodbefgpgknn-10.16.1-Crx4Chrome.com.crx"));
    ...
    public void afterMethod(ITestResult result, Method method) throws Exception {
        ...
        if (result.getStatus() == 2) {
            ...
            fileName = "/Users/Viren/Work/Automation/old_chainpal_Automation/Reports/Failure_Screenshots/" + dateEndInString + ".png" ;
